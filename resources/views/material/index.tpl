    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ml-lg-3 align-items-lg-center">
                ...
                <!--<li class="nav-item"><a href="https://buy.rhinod.org/" target="_blank" class="nav-link">杂货铺</a></li>
                <li class="nav-item"><a href="https://rhinod.org/" target="_blank" class="nav-link">黑犀牛固件</a></li>-->
            </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 pl-lg-5 col-md-12">
                ...
                <p class="lead">黑犀牛加速器 的服务适用于 macOS、iOS、Android、Windows 和 Linux，借助第三方客户端，可在手机、电脑、路由器、游戏机、电视盒子中使用。</p>
                <div class="mt-4">
                    ...
                    <div class="pricing-padding">
                        ...
                        <div class="pricing-details">
                            <div class="pricing-item">
                                ...
                                <div class="pricing-item-label">100GB 使用流量/月</div>
                            </div>
                            <div class="pricing-item">
                                <div class="pricing-item-icon" style="background:#6574f7"><i class="fas fa-check"></i></div>
                ...
                <div class="pricing">
                    ...
                    <div class="pricing-padding">
                        ...
                        <div class="pricing-details">
                            <div class="pricing-item">
                                <div class="pricing-item-icon" style="background:#6574f7"><i class="fas fa-check"></i></div>
                                <div class="pricing-item-label">200GB 使用流量/月</div>
                            </div>
                            <div class="pricing-item">
                                <div class="pricing-item-icon" style="background:#6574f7"><i class="fas fa-check"></i></div>
                                <div class="pricing-item-label">2个 在线客户端</div>
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="pr-lg-5">
                    ...
                    <!-- 请保留原作者版权信息 -->
                    <p>&copy;{date("Y")} {$config["appName"]} 版权所有</p>
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
